...
class CampusNetworkTopo(Topo):
    ...
    def build(self):
        ...
        vpn_inside_switch = self.addSwitch("vs", dpid="0000000000000200")  # VPN 内部交换机 VLAN200
        internet_switch = self.addSwitch("is", dpid="0000000000000300")  # Internet 交换机 VLAN300
        ...
        self.addLink(vpn_server, server_switch)
